...
* 2.3.0: Fixed the error of [19:15:26] [Server thread/CRITICAL]: ErrorException: ""continue" targeting switch is equivalent to "break". Did you mean to use "continue 2"?" (EXCEPTION) in "plugins/ManyWorlds.phar/src/aliuly/manyworlds/MwLvDat" at line 86 And the / mw lvdat command was removed
